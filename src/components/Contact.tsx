...
const translations = {
  en: {
    ...
    info: {
      address: 'Address',
      addressValue: 'Managua, Nicaragua',
      phone: 'Phone',
      phoneValue: '+505 8362 1049',
      email: 'Email',
      emailValue: 'info@serpub.com',
  ...
  es: {
    title: 'Contáctenos',
    subtitle: 'Comuníquese con nuestro equipo',
    form: {
      name: 'Su Nombre',
        ...
        <div className="max-w-6xl mx-auto bg-white rounded-2xl shadow-xl overflow-hidden">
          <div className="grid grid-cols-1 md:grid-cols-2">
            <div className="bg-blue-700 text-white p-8 md:p-12">
              <div className="mb-8">
                <h3 className="text-2xl font-semibold mb-6">{language === 'es' ? 'Información de Contacto' : 'Contact Information'}</h3>
              ...
              <div className="mt-12">
                <h4 className="text-xl font-semibold mb-4">{language === 'es' ? 'Síguenos' : 'Follow Us'}</h4>
                <div className="flex space-x-4">
                  <a href="https://www.facebook.com/people/SerPub/61566510266975/?_rdr" className="w-10 h-10 bg-white/20 rounded-full flex items-center justify-center hover:bg-white/30 transition-colors">
                    <span className="sr-only">Facebook</span>
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                      <path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd"></path>
                    </svg>
                  </a>
                  <a href="https://www.instagram.com/serpub_/" className="w-10 h-10 bg-white/20 rounded-full flex items-center justify-center hover:bg-white/30 transition-colors">
            ...
            <div className="p-8 md:p-12">
              {isSubmitted ? (
                <div className="h-full flex flex-col items-center justify-center py-8">
                  ...
                  <p className="text-lg font-medium text-gray-800 text-center">{t.form.success}</p>
                </div>
              ) : (
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    type="submit"
                    className="w-full px-6 py-3 bg-blue-600 text-white font-medium rounded-lg shadow hover:bg-blue-700 transition-colors"
                  >
                    {t.form.submit}
                  </button>
                </form>
